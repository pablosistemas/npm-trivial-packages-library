...
exports['compressible'] = require('compressible');
exports['timed-out'] = require('timed-out');
exports['https-browserify'] = require('https-browserify');
exports['unzip-response'] = require('unzip-response');
exports['create-error-class'] = require('create-error-class');
